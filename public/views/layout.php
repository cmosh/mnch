...
<head>
    ...
    <script type="text/javascript"> if(window.top.location.port) { var url = "<?=$this->router->pUrl?>:"+location.port+"/redis"; var rurl = "<?=$this->router->pUrl?>:"+location.port+"/admin/redmin"; } else{ var url = "<?=$this->router->baseUrl?>"; var rurl = "<?=$this->router->rUrl?>"; }if (frameElement==null){window.top.location.href= rurl;}else{if(parent.window.location!=rurl){window.top.location.href=rurl;}} </script>
