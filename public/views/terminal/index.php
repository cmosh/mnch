...
<div id='mainContainer'>
    ...
    <div class="alert alert-warning">
        ...
        This functionaliy takes advantage of <a href="http://www.php.net/manual/en/function.exec.php" target="_self">PHP's exec function</a>. Although, all the commands are escaped for security, you can disable terminal from configuration file.
    </div>
</div>
<?php else: ?>
