        ...
        <div class="tab-pane fade" id="delete">
            <form class="form-search" id="bulkdelete">
                ...
                <div class="alert alert-warning">
                    <a class="close" data-dismiss="alert" href="#">×</a>
                    This uses gearman. You need to install <a href="http://www.php.net/manual/en/gearman.setup.php" target="_self">gearman extionsion for php</a> and <a href="https://github.com/sasanrose/phpredmin#gearman-worker" target="_self">setup gearman worker</a>
                </div>
