...
<div id='mainContainer'>
    ...
    <table class="table table-striped keys-table">
        ...
        <tr>
            ...
            <td>
                <a href="<?=$this->router->url?>/keys/expire/<?= $this->app->current['serverId'] . '/' . $this->app->current['database'] ?>/<?=urlencode($key)?>" target="_self" class="action">
                    <i class="icon icon-time"></i>
                </a>
            </td>
            <td>
                <a href="<?=$this->router->url?>/keys/rename/<?= $this->app->current['serverId'] . '/' . $this->app->current['database'] ?>/<?=urlencode($key)?>" target="_self" class="action">
                    <i class="icon icon-edit"></i>
                </a>
            </td>
            <td>
                <a href="<?=$this->router->url?>/keys/view/<?= $this->app->current['serverId'] . '/' . $this->app->current['database'] ?>/<?=urlencode($key)?>" target="_self" class="action">
                    <i class="icon icon-folder-open-alt"></i>
                </a>
            </td>
            <td>
                <a href="<?=$this->router->url?>/keys/move/<?= $this->app->current['serverId'] . '/' . $this->app->current['database'] ?>/<?=urlencode($key)?>" target="_self" class="action">
