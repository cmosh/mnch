...
<head>
	...
	<link rel="stylesheet" media="all" type="text/css" href="<?=$this->router->baseUrl?>/assets/redmin/bootstrap/css/bootstrap.min.css" />
    <link rel="stylesheet" media="all" type="text/css" href="<?=$this->router->baseUrl?>/assets/redmin/bootstrap/css/bootstrap-responsive.min.css">
    <link rel="stylesheet" media="all" type="text/css" href="<?=$this->router->baseUrl?>/assets/redmin/font-awesome/css/font-awesome.min.css">
	<link rel="stylesheet" media="all" type="text/css" href="<?=$this->router->baseUrl?>/assets/redmin/js/nvd3/src/nv.d3.css" />
	<link rel="stylesheet" media="all" type="text/css" href="<?=$this->router->baseUrl?>/assets/redmin/css/custom.css" />
	<link rel="stylesheet" media="all" type="text/css" href="<?=$this->router->baseUrl?>/assets/redmin/js/jquery-ui/css/jquery-ui.min.css" />
    <script type="text/javascript" src="<?=$this->router->baseUrl?>/assets/redmin/js/jquery.min.js"></script>
    <script type="text/javascript" src="<?=$this->router->baseUrl?>/assets/redmin/bootstrap/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="<?=$this->router->baseUrl?>/assets/redmin/js/redmin/main.js"></script>
    <script type="text/javascript" src="<?=$this->router->baseUrl?>/assets/redmin/js/redmin/modal.js"></script>
