<?php $this->addHeader("<script type=\"text/javascript\" src=\"{$this->router->baseUrl}/assets/redmin/js/nvd3/lib/d3.v2.min.js\"></script>"); ?>
<?php $this->addHeader("<script type=\"text/javascript\" src=\"{$this->router->baseUrl}/assets/redmin/js/nvd3/nv.d3.js\"></script>"); ?>
<?php $this->addHeader("<script type=\"text/javascript\" src=\"{$this->router->baseUrl}/assets/redmin/js/moment.min.js\"></script>"); ?>
<?php $this->addHeader("<script type=\"text/javascript\" src=\"{$this->router->baseUrl}/assets/redmin/js/jquery-ui/js/jquery-ui.min.js\"></script>"); ?>
