<select style="width:100%" multiple name="graphs" id="graphs" hidden>
  <option selected value="CHV1_resources">CHV1_ownership</option>
</select>
               ...
               <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Availability 
                    <small class="cmpr">
                   <a href="{{config('app.prefix')}}{{config('app.prefix')}}/comparison/CHV1/CHV1_resources/colfullstack/" class="btn-primary btn-xs">Launch Comparison</a>
                    </small>
                  </h3>
