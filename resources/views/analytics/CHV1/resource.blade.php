<select style="width:100%" multiple name="graphs" id="graphs" hidden>
  <option selected value="CHV2_resources">CHV2_ownership</option>
</select>
...
<select style="width:100%" multiple name="thetypes" id="thetypes" hidden>
  ...
  <div id="dialog" title="Dialog Title"></div>
                     ...
                     <div class=" " >
                         <br>                     
                        <center ><h2 id="info-title"><b>RESOURCES</b></h2></center>
                        <br>
                        </div>
                        </div>
</div>
               ...
               <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Availability 
                    <small class="cmpr">
                   <a href="{{config('app.prefix')}}{{config('app.prefix')}}/comparison/CHV2/CHV2_resources/colfullstack/" class="btn-primary btn-xs">Launch Comparison</a>
                    </small>
                  </h3>
