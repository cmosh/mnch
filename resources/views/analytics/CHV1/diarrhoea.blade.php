               ...
               <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Commodities
                   <small class="cmpr">
                      <a href="{{config('app.prefix')}}/comparison/CHV1/CHV1_DTreatmentCommodities/colfullstack/" class="btn-primary btn-xs">Launch Comparison</a>
              ...
              <div id="CHV1_DTreatmentCommodities"></div>     
               ...
               <div class="box box-success">
                <div class="box-header with-border">
                  ...
                  <small class="cmpr">
                   <a href="{{config('app.prefix')}}/comparison/CHV1/CHV1_DTreatmentAvailability/colfullstack/" class="btn-primary btn-xs">Launch Comparison</a>
