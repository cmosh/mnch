<select style="width:100%" multiple name="graphs" id="graphs" hidden>
  <option selected value="CHV1_comm_strategy">CHV1_ownership</option>
</select>
...
<select style="width:100%" multiple name="thetypes" id="thetypes" hidden>
  ...
  <div id="dialog" title="Dialog Title"></div>
                     ...
                     <div class=" " >
                         <br>                     
                        <center ><h2 id="info-title"><b>COMMUNITY STRATEGY</b></h2></center>
                        <br>
                        </div>
                        </div>
</div>
               ...
               <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Trained in ICCM 
                    <small class="cmpr">
                   <a href="{{config('app.prefix')}}/comparison/CHV1/CHV1_comm_strategy/colfullstack/" class="btn-primary btn-xs">Launch Comparison</a>
                    </small>
                  </h3>
