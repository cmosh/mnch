               ...
               <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Commodities
                   <small class="cmpr">
                      <a href="/comparison/CHV1/CHV1_Antibiotics/colfullstack/" class="btn-primary btn-xs">Launch Comparison</a>
              ...
              <div id="CHV1_Antibiotics"></div>     
               ...
               <div class="box box-success">
                <div class="box-header with-border">
                  ...
                  <small class="cmpr">
                   <a href="/comparison/CHV1/CHV1_AntibioticsAvailability/colfullstack/" class="btn-primary btn-xs">Launch Comparison</a>
