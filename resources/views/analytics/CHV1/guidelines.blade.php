               ...
               <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Guidelines
                   <small class="cmpr">
                     <a href="/comparison/CHV1/CHV1_Guidelines/barfullstack/" class="btn-primary btn-xs">Launch Comparison</a>
                    </small>
                  </h3>
              ...
              <div id="CHV1_Guidelines"></div>     
               ...
               <div class="box box-success">
                <div class="box-header with-border">
                  ...
                  <small class="cmpr">
                   <a href="/comparison/CHV1/CHV1_Tools/barfullstack/" class="btn-primary btn-xs">Launch Comparison</a>
                    </small>
                    <button class="btn btn-box-tool pull-right" data-widget="collapse"><i class="fa fa-minus"></i></button>
                </div>
                <div class="box-body">
