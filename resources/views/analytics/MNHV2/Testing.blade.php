<select style="width:100%" multiple name="graphs" id="graphs" hidden>
  <option selected value="MNHV2_testing">CHV2_ownership</option>
</select>
               ...
               <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Testing Supplies 
                    <small class="cmpr">
                   <a href="/comparison/MNHV2/MNHV2_testing/barfullstack/" class="btn-primary btn-xs">Launch Comparison</a>
                    </small>
                  </h3>
