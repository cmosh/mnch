            ...
            <div class="col-md-6">
               <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Cases Treated with Zinc + ORS
                  <small class="cmpr">
                     <a id="Year3Change" href="/comparison/CHV2/CHV2_u5RegisterN/col/{{$YearsCount1}}" class="btn-primary btn-xs">Launch Comparison</a>
               ...
               <div class="box box-success">
                <div class="box-header with-border">
                  <h3 class="box-title">Annual ORT Corner Management Trends
                    <small class="cmpr">
                   <a id="Year4Change" href="/comparison/CHV2/CHV2_annualtrendsN/col/{{$YearsCount2}}" class="btn-primary btn-xs">Launch Comparison</a>
