               ...
               <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Treatment Data in Under 5 Register
                    <small class="cmpr">
                    <a id="Year1Change" href="/comparison/CHV2/CHV2_u5Register/col/{{$YearsCount1}}" class="btn-primary btn-xs">Launch Comparison</a> 
                    </small>
                  </h3>
               ...
               <div class="box box-success">
                <div class="box-header with-border">
                  <h3 class="box-title">Annual Treatment Trends
                     <small class="cmpr">
                   <a id="Year2Change" href="/comparison/CHV2/CHV2_annualtrends/colfullstack/{{$YearsCount2}}" class="btn-primary btn-xs">Launch Comparison</a>
                    </small>
                  </h3>
