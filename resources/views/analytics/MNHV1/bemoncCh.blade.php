<select style="width:100%" multiple name="graphs" id="graphs" hidden>
  <option selected value="MNHV2_BemoncChallenge">CHV2_ownership</option>
</select>
...
<select style="width:100%" multiple name="thetypes" id="thetypes" hidden>
  ...
  <div id="dialog" title="Dialog Title"></div>
   ...
   <div class="col-md-12" >
               <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Challenges Experienced in Service Provison 
                    <small class="cmpr">
                   <a href="{{config('app.prefix')}}/comparison/MNHV2/MNHV2_BemoncChallenge/barfullstack/" class="btn-primary btn-xs">Launch Comparison</a>
                    </small>
                  </h3>
              ...
              <div id="MNHV2_BemoncChallenge"></div>     
                </div><!-- /.box-body -->
