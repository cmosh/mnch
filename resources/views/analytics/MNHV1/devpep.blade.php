...
<select style="width:100%" multiple name="thetypes" id="thetypes" hidden>
  ...
  <div id="dialog" title="Dialog Title"></div>
                     ...
                     <div class=" " >
                         <br>                     
                        <center ><h2 id="info-title"><b>MATERNAL AND NEONATAL SERVICE DELIVERY
</b></h2></center>
                        <br>
                        </div>
                        </div>
               ...
               <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Preparedness for Delivery 
                    <small class="cmpr">
                   <a href="/comparison/MNHV1/MNHV1_devpep/barfullstack/" class="btn-primary btn-xs">Launch Comparison</a>
                    </small>
                  </h3>
