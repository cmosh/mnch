<select style="width:100%" multiple name="graphs" id="graphs" hidden>
  <option selected value="MNHV2_bedcapacity">CHV2_ownership</option>
</select>
   ...
   <div class="col-md-12" >
               <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Bed Capacity 
                    <small class="cmpr">
                   <a href="{{config('app.prefix')}}{{config('app.prefix')}}/comparison/MNHV2/MNHV2_bedcapacity/colfullstack/" class="btn-primary btn-xs">Launch Comparison</a>
                    </small>
                  </h3>
